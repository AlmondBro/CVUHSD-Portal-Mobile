        ...
        <ScrollView contentContainerStyle={appStyles.scrollView}>
          ...
          <View style={[appStyles.blueSectionContainer, this.getWidth()]}>
            ...
            <BlueSection 
              title="Quick Links" 
              expanded={true}
              buttons={this.staffPortalButtons.quickLinks}
            />
              <BlueSection 
              title="Standard Staff Tools " 
              expanded={false}
              buttons={this.staffPortalButtons.standardStaffTools}
            />
            <BlueSection 
              title="Administrative Tools" 
              expanded={true}
              buttons={this.staffPortalButtons.administrativeTools}
            />
            <BlueSection 
              title="Teacher Tools" 
              expanded={false}
              buttons={this.staffPortalButtons.teacherTools}
            />
            <BlueSection 
              title="Classroom Tools" 
              expanded={false}
              buttons={this.staffPortalButtons.classroomTools}
            />
            <BlueSection 
              title="Learning Tools" 
              expanded={false}
              buttons={this.staffPortalButtons.learningTools}
            />
            <BlueSection 
              title="Digital Textbooks" 
              expanded={false}
              buttons={this.staffPortalButtons.digitalTextbooks}
            />
            {/* needs right buttons! */}
             <BlueSection 
            ...
            />
             <BlueSection 
              ...
              expanded={true}
              buttons={this.staffPortalButtons.schoolWebsites}
            />
          </View>
